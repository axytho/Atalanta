...
`define FIRST_NTT_LATENCY (`JEWEL_REGISTERS*`LOG_COEF_PER_CC+`TAIL_REDUCTION)
`define FORWARD_NTT_1024_LATENCY ((`LOG_COEF_PER_CC == `LOG_N) ?  `FIRST_NTT_LATENCY : (`MATRIX_TRANSPOSE_LATENCY+(`JEWEL_REGISTERS*`LOG_N+2*`TAIL_REDUCTION)+`MULTIPLIER_LATENCY+`REDUCTION_LATENCY))
